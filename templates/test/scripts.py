...
# Find the templates folder from the PATH environment variable
path_dirs = os.environ['PATH'].split(os.pathsep)
templates_path = None
for path_dir in path_dirs:
    exe_path = os.path.join(path_dir, "scripts.exe")
    if os.path.isfile(exe_path):
        templates_path = os.path.join(os.path.dirname(exe_path), "templates")
        break

# Create the "templates" folder if it doesn't exist
if templates_path is not None and not os.path.exists(templates_path):
